...
let colors_name = "lilypink_sunny"
...
if version >= 700
  ...
  highlight CursorLineNr guifg=#4f4f4f guibg=#303030 ctermfg=255 ctermbg=236 cterm=NONE
...
highlight LineNr guifg=#444444 guibg=#242424 gui=NONE ctermfg=239 ctermbg=235 cterm=NONE
...
highlight IncSearch guifg=#33ff1c guibg=#000000 gui=underline ctermfg=210 ctermbg=16 cterm=underline
" highlight Search guifg=NONE guibg=#000000 ctermfg=NONE ctermbg=16 cterm=NONE
highlight Search guifg=NONE guibg=#000000 ctermfg=210 ctermbg=16 cterm=NONE
