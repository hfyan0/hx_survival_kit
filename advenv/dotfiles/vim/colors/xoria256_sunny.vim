...
let colors_name = "xoria256_sunny"
"}}}
" Colours {{{1
"" General {{{2
...
hi IncSearch    ctermfg=255 guifg=#000000 ctermbg=52 guibg=#ffdfaf cterm=none gui=none
...
hi Search       ctermfg=255 guifg=#000000 ctermbg=52 guibg=#afdf5f
